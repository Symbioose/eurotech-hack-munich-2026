...
Physical Cursor turns a dense-city problem into a reviewable hardware brief:

> deployment context, 3D node, component graph, BOM, DfMA warning, Apply Fix and Hong Kong/GBA supplier route.
